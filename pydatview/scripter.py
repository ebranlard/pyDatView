...
class PythonScripter:
    def __init__(self, **opts):
        ...
        # Add disclaimer to docstring
        self.docstrings.append('Script generated by pyDatView - The script will likely need to be adapted.')
    ...
    def setPlotType(self, plotType, plotTypeOptions=None):
        ...
        if plotType is not None and plotType!='Regular':
            if plotType=='PDF':
                ...
                warn = "[WARN] Scripter:  plot type '{}' not yet implemented".format(plotType)
                print(warn)
                self.docstrings.append(warn)
